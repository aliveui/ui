...
import alive from '../public/logomark.svg';
...
export const Installer = ({ packageName }: InstallerProps) => {
  const [value, setValue] = useState('alive-ui');

  const commands = {
    'alive-ui': {
      image: alive,
      code: `npx @aliveui/ui@latest add ${packageName}`,
    },
    shadcn: {
      image: shadcn,
      code: `npx shadcn@latest add https://www.aliveui.com/registry/${packageName}.json`,
    },
  };
